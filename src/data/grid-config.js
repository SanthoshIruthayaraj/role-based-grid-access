...
export const columns = [
  { field: 'id', headerText: 'ID', type: 'number', isPrimaryKey: true, width: 100, textAlign: 'Right', allowEditing: false },
  ...
  { field: 'contact', headerText: 'Contact', width: 170, clipMode: 'EllipsisWithTooltip' },
];

// Built-in demo login accounts.
export const DEMO_ACCOUNTS = [
  { role: 'Admin', userId: 'admin', password: 'admin123' },
  { role: 'Manager', userId: 'manager', password: 'manager123' },
  { role: 'Employee', userId: 'employee', password: 'employee123' },
];